...
scale_mapping = {'PKP3a': CONN_SCALE_PKP, 'PG': CONN_SCALE_PG, 'DP': CONN_SCALE_DP, 'DSC1': CONN_SCALE_DC,
...
for i in range(len(dsg_molecules)):
    ...
    binding_res = MinimumPairDistanceBindingRestraint(mdl, plist1, plist2, 0, 1, "DSG1_PKP3_MPDBR",
...
for i in range(len(dsc_molecules)):
    ...
    plist2 = IMP.pmi.tools.select_by_tuple_2(root_hierarchy, selection_tuple, MPDBR_RES)
    binding_res = MinimumPairDistanceBindingRestraint(mdl, plist1, plist2, 0, 1, "DSC1_PKP3_MPDBR",
...
for i in range(PKP_NUMBER):
    ...
    binding_res = MinimumPairDistanceBindingRestraint(mdl, plist1, plist2 + plist3, 0, 1, "PKP3_DSC1G1_MPDBR",
